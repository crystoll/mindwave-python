            ...
            while True:
                ...
                try:
                    if s.read() == SYNC and s.read() == SYNC:
                        ...
                        chksum = s.read()[0]
#                        if val == chksum:
#                            print('Checksum checks okay')
#                        else:
#                            print('Value: {}, checksum {}'.format(val, chksum))
